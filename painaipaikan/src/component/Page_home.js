      ...
      <div>
        ...
        <section className="my-5">
          ...
          <p className="grey-text w-responsive text-center mx-auto mb-5">
            เว็บไซต์นี้จัดทำขึ้นเพื่อ แนะนำสถานที่ท่องเที่ยวภายในประเทศไทย แลกเปลี่ยนการท่องเที่ยวของกันและกัน 
            โดยผู้ใช้สามารถเข้ามาแชร์ประสบการณ์การการท่องเที่ยวของท่านให้ผู้อื่นได้รับรู้ได้
        </p>
        </section>
